...
@Component({
  ...
  template: `
    <div class="card shadow-sm border-0 mb-4">
      ...
      <div *ngIf="!isLoading && artiste" class="card-body text-center py-4">
        <p class="fs-5">
          Etes-vous sur de vouloir supprimer
          <strong class="text-primary">{{ artiste.nomDeScene || (artiste.nom + ' ' + artiste.prenom) }}</strong> ?
        </p>
...
export class DeleteArtiste implements OnInit {
  ...
  constructor(private route: ActivatedRoute, private router: Router, private artisteService: ArtisteApiService) {}
